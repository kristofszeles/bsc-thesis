...
% Dolgozat metaadatai
% Document's metadata
\title{Többjátékos 3D labirintusjáték megvalósítása OpenGL-ben} % cím / title
\date{2021} % védés éve / year of defense

% Szerző metaadatai
% Author's metadata
\author{Széles Kristóf}
\degree{programtervező informatikus BSc}

% Témavezető(k) metaadatai
% Superivsor(s)' metadata
\supervisor{Pataki Norbert} % belső témavezető neve / internal supervisor's name
\affiliation{egyetemi docens} % belső témavezető beosztása / internal supervisor's affiliation
