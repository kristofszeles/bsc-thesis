#!/bin/sh
# Build maze-game on Linux using system SDL2/GLEW/GTK (CI and clean machines).
# Does not rely on a prebuilt libnfd in maze-game/lib/ — builds nativefiledialog-extended.
